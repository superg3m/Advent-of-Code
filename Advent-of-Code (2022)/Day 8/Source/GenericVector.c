...
void test_vector_operations() {
    ...
    for (int i = 0; i < stringVector.size; i++) {
        ...
        assert_msg(strcmp(*element, stringArray[i]) == 0, "Error: Incorrect element value");
    }
    ...
    assert_msg(*poppedInt == intArray[intVector.size], "Error: Incorrect popped element value");
    ...
    printf("\x1b[32m" "All vector tests passed!" "\n" "\x1b[0m");  // Green checkmark
}